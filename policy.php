...
<body>
  ...
  <h1 class="title page-title"><span>Privacy Policy</span></h1>
  <div id="information-information" class="container">
    <div class="row">
      <div class="col-sm-12">
        <div class="content">
          <p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from zukhrufmart.com (the "Site").</p>
       <br>   <blockquote>Personal information we collect</blockquote>
...
When we talk about "Personal Information" in this Privacy Policy, we are talking both about Device Information and Order Information. </p>
         <blockquote>How do we use your personal information?</blockquote>
          <p>We use the Order Information that we collect generally to fulfill any orders placed through the Site (including processing your payment information, arranging for shipping, and providing you with invoices and/or order confirmations). Additionally, we use this Order Information to:<br> </P>
...
- Bing: https://advertise.bingads.microsoft.com/en-us/resources/policies/personalized-ads<br><br>
...
<blockquote>Do not track</blockquote>
        
   <p>Please note that we do not alter our Site's data collection and use practices when we see a Do Not Track signal from your browser.<br>

Additionally, if you are a European resident we note that we are processing your information in order to fulfill contracts we might have with you (for example if you make an order through the Site), or otherwise to pursue our legitimate business interests listed above. </p>
     

<blockquote>Contact us</blockquote>
        
   <p> 
   For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e‑mail at info@zukhrufmart.com or by mail using the details provided below:<br><br></p>
     <p> zukhrufmart.com<br></p>
     <p>House #29 Street#35-A  I-9/4 Islamabad</p>
     <p>Phone #  +92318-1542541</p>
...
<br>   </div>
  ...
  <script src="js/010ed15c405addda46e0b93714ef385a.js" defer=""></script>

...
function get_product($con,$limit='',$cat_id='',$product_id='',$search_str='',$sort_order='',$is_best_seller='',$sub_categories='',$is_special=''){
	...
	if($is_special!=''){
		$sql.=" and product.special=1 ";
	}
	 if($is_best_seller!='' && $cat_id!='' )
	 {
		$sql.=" and product.best_seller=1"; 
	 }
     if($is_special!='' && $cat_id!='' )
	 {
		$sql.=" and product.special=1"; 
	 }
...
function sentInvoice($con,$order_id){
	...
	$mail->SMTPSecure="tls";
	$mail->SMTPAuth=true;
	$mail->Username="ytlearnwebdevelopmment@gmail.com";
	$mail->Password="vishal@1234567";
	$mail->SetFrom("ytlearnwebdevelopmment@gmail.com");

            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12"  >
                        <h2 class="title__line--6" style="margin-left:20px">CONTACT US</h2>
                        <div class="address" style="margin-left:20px">
                            ...
                            <div class="address__details" >
                                ...
                                <p>House #29 Street#35-A <br> I-9/4 Islamabad </p>
                            </div>
                        </div>
                        <div class="address" style="margin-left:20px">
                            <div class="address__icon">
                            ...
                            <div class="address__details">
                                ...
                                <p>9:00AM to 5:00PM, Islamabad Standard time </p>
                            </div>
                        </div>
    ...
    <script>
        ...
        function init() {
            var mapOptions = {
                ...
                center: new google.maps.LatLng(32.5731, 74.1005), // Gujrat
        ...
        [ {
            ...
            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(32.5731, 74.1005),
                map: map,
                title: 'Ramble!',
